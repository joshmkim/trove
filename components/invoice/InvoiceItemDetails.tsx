...
export default function InvoiceItemDetails({ items, onChange }: InvoiceItemDetailsProps) {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-[minmax(0,1fr)_80px_120px_100px_110px] gap-x-3 gap-y-2">
        {/* Column headers */}
        ...
        <span className="text-xs text-warm-gray font-medium px-2.5">Unit Price</span>
        <span className="text-xs text-warm-gray font-medium px-2.5">Line Total</span>
